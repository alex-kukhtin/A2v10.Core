...
namespace A2v10.Core.Web.Mvc
{
	...
	public class RequestCommand : RequestBase
	{
		...
		/*
		public Task<ServerCommandResult> ExecuteCommand(IServiceProvider locator, ExpandoObject data)
		{
	...
	public class RequestModel
	{
		...
		public static async Task<RequestModel> CreateFromApiUrl(IAppCodeProvider codeProvider, String apiUrl)
		{
			apiUrl = apiUrl.ToLowerInvariant();
			var rm = await CreateFromUrl(codeProvider, RequestUrlKind.Api, apiUrl + "/0" /*id*/);
			rm._kind = RequestUrlKind.Api;
			return rm;
		}

		public static async Task<RequestModel> CreateFromBaseUrl(IAppCodeProvider codeProvider, String baseUrl)
		{
			...
			var rm = await CreateFromUrl(codeProvider, kind, baseUrl);
			rm._kind = kind;
			return rm;
		}
	}
