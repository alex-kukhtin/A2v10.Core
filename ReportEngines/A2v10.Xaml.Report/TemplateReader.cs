...
{
	// Кандидаты для probe файлового маршрута движка: имя в model.json расширения не несёт. У слоя
	// метаданных список свой (PrintRequest): туда бланк движку приходит потоком, и пробы он не делает
